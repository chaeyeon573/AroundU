...
import type { Patch, Snapshot, RegisterInput } from '@/api/types';
import type { ID } from '@/types';
import { createEngine } from '@/api/engine';
import { searchCatalog, catalogCourses as builtInCatalog } from '@/data/catalog/courses';
