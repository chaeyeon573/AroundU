...
export function ProfilePage() {
  ...
  return (
    <div className="min-h-full pb-6">
      <TopBar title={t('프로필')} messages right={<button onClick={() => nav('/settings')} className="h-10 w-10 grid place-items-center rounded-full" aria-label={t('설정')}><Settings size={22} /></button>} />
