import { Coffee, Utensils, BookOpen, Dumbbell, Music, Mic2, GraduationCap, FlaskConical, Handshake, Tag, Sparkles, type LucideIcon } from 'lucide-react';
...
export const OPP_ICON: Record<OpportunityType, LucideIcon> = {
  event: GraduationCap, club: Music, lab: FlaskConical, internship: Handshake, scholarship: GraduationCap, hackathon: Sparkles, startup: Handshake, activity: Coffee,
};
...
export const OPP_TINT: Record<OpportunityType, string> = { event: '#FBBE02', club: '#F1A7A1', lab: '#A7C6ED', internship: '#C7D8B8', scholarship: '#FFD2B5', hackathon: '#A7C6ED', startup: '#FF6F61', activity: '#FFD2B5' };
