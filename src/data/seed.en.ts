...
export const opportunityIntents: OpportunityIntentRecord[] = [
  ...
  { id: 'oi16', opportunityId: 'op_sorority', userId: 'u_jimin', intent: 'applying', saved: true, createdAt: isoHoursAgo(6) },
  { id: 'oi17', opportunityId: 'op_sorority', userId: 'u_sua', intent: 'interested', saved: false, createdAt: isoHoursAgo(3) },
  { id: 'oi18', opportunityId: 'op_frat', userId: 'u_junho', intent: 'applying', saved: true, createdAt: isoHoursAgo(7) },
